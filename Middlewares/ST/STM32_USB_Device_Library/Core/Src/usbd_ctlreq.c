...
static void USBD_GetOsDescriptor(USBD_HandleTypeDef *pdev ,
                               USBD_SetupReqTypedef *req);
...
USBD_StatusTypeDef  USBD_StdDevReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef  *req)
{
  ...
  case WINUSB_MS_VENDOR_CODE:
	USBD_GetOsDescriptor (pdev, req) ;
    break;
...
/**
* @brief  USBD_GetOsDescriptor
*         Handle Get OS Descriptor requests
* @param  pdev: device instance
* @param  req: usb request
* @retval status
*/
                               ...
                               USBD_SetupReqTypedef *req)
{
  ...
  pbuf = pdev->pDesc->GetOsDescriptor(pdev->dev_speed, req, &len);
